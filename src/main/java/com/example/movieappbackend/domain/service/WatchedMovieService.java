...
@Service
public class WatchedMovieService extends UserMovieListServiceAbstract {

	public WatchedMovieService(MovieListItemRepository repository, UserService userService) {
